...
public class MemberController {
     ...
     * <p>
     * 이 API는 사용자가 카카오 서비스와의 연결을 해제하고, 해당 사용자의 회원 정보를 탈퇴 처리합니다.
     * 사용자는 Bearer 토큰을 통해 인증되어야 하며, 해당 토큰은 요청 헤더에 포함되어야 합니다.
     * 성공적으로 처리되면, 사용자는 카카오 서비스와의 연결이 해제되며, 회원 탈퇴가 진행됩니다.
     * </p>
     *
     ...
     * 회원 정보를 수정하는 API입니다.
     * <p>
     * 이 API는 회원의 정보를 수정하는 기능을 제공합니다. 현재 구현된 기능은 닉네임 수정입니다.
     * 사용자는 Bearer 토큰을 통해 인증된 후에만 이 API를 사용할 수 있습니다. 토큰은 요청 헤더에 포함되어야 합니다.
     * <p>
     * @param token 사용자 인증을 위한 Bearer 토큰. 요청 헤더에서 'Authorization'으로 제공되어야 합니다. 필수 파라미터입니다.
     ...
     * 회원 정보를 조회하는 API입니다.
     *
     * <p>이 메서드를 통해 사용자는 자신의 회원 정보를 조회할 수 있습니다. 사용자 인증을 위해 Bearer 토큰이 요청 헤더에 포함되어야 합니다.</p>
     *
