...
public interface PostQueryRepository {
    ...
    PageResultData<GetAllPostsResponse> findAllPostsByLatest(Long memberNo, Pageable pageable);
    PageResultData<GetAllPostsResponse> findAllPostsByRecommended(Long memberNo, Pageable pageable);
    PageResultData<GetAllPostsResponse> findAllPostsByLikeCnt(Long memberNo, Pageable pageable);
    PageResultData<GetAllPostsResponse> findAllPostsByDistance(Long memberNo, Pageable pageable);
