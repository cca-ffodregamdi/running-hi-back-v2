...
VALUES
    ...
    ('ILLEGAL', '부적절한 내용이 포함된 댓글입니다.', 'INPROGRESS', 2, 1, (SELECT reply_content FROM tbl_reply WHERE reply_no = 1), false),
    ('ILLEGAL', '부적절한 내용이 포함된 댓글입니다.', 'INPROGRESS', 2, 3, (SELECT reply_content FROM tbl_reply WHERE reply_no = 3), false);
